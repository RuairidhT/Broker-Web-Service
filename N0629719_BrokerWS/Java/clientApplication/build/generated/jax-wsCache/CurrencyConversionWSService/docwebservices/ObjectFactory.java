...
public class ObjectFactory {
    ...
    private final static QName _RunAPIResponse_QNAME = new QName("http://DOCwebServices/", "runAPIResponse");
    private final static QName _RunAPI_QNAME = new QName("http://DOCwebServices/", "runAPI");
    ...
    /**
     * Create an instance of {@link RunAPI }
     * 
     */
    public RunAPI createRunAPI() {
        return new RunAPI();
    }

    /**
     * Create an instance of {@link RunAPIResponse }
     * 
     */
    public RunAPIResponse createRunAPIResponse() {
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link RunAPIResponse }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://DOCwebServices/", name = "runAPIResponse")
    public JAXBElement<RunAPIResponse> createRunAPIResponse(RunAPIResponse value) {
        return new JAXBElement<RunAPIResponse>(_RunAPIResponse_QNAME, RunAPIResponse.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link RunAPI }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://DOCwebServices/", name = "runAPI")
    public JAXBElement<RunAPI> createRunAPI(RunAPI value) {
        return new JAXBElement<RunAPI>(_RunAPI_QNAME, RunAPI.class, null, value);
    }
